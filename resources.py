...
class PokeAPI():
    ...
    def __pokemon_object_mapping(self, pokemon) -> object:
        '''
    ...
    def get_all_pokemons(self, offset: int = 0, limit: int = 20) -> dict:
        '''
        ...
        o método de pokemon mapping.
            ...
            Returns:
                    data (dict): Um dicionário com os dados de Pokémons e informações da requisição.  
        '''
        try:
            ...
            return {"data": object_response, "message": "Pokémons obtidos com sucesso."}
        except Exception as e:
            return {"data": False, "message": "Erro ao recuperar os dados de Pokémons.", "error": str(e)}
